...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        //   scrollDown(By.xpath("//html[@class='html-category-page']"),200);
        ...
        sendTextToElement(By.id("FirstName"), "Anna");
        sendTextToElement(By.id("LastName"), "piter");
        sendTextToElement(By.id("Email"), "annapiter231@yahoo.com");
        Thread.sleep(2000);
        sendTextToElement(By.id("Password"), "a12345");
        sendTextToElement(By.id("ConfirmPassword"), "a12345");
        ...
        sendTextToElement(By.xpath("//input[@data-val-required='Street address is required']"), "76,Corporation road");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"), "LE45NJ");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "07896543210");
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Anna Piter");
        sendTextToElement(By.xpath("//input[@id='CardNumber']"), "4929218365529419");
        Thread.sleep(2000);
        selectByValueDropDown(By.xpath("//select[@id='ExpireMonth']"), "5");
        selectByValueDropDown(By.xpath("//select[@id='ExpireYear']"), "2025");
        sendTextToElement(By.xpath("//input[@id='CardCode']"), "142");
